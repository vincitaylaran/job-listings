  ...
  return (
    <svg width={88} height={88} {...props}>
      <defs>
        ...
        <circle id="photosnap_svg__a" cx={44} cy={44} r={44} />
      </defs>
      <g fill="none" fillRule="evenodd">
        <use fill="#000" xlinkHref="#photosnap_svg__a" />
        <use
          fill="#000"
          filter="url(#photosnap_svg__b)"
          xlinkHref="#photosnap_svg__a"
        />
        <path
          fill="#FFF"
          fillRule="nonzero"
