...
function SvgMyhome(props) {
  return (
    <svg width={88} height={88} {...props}>
      <defs>
        <linearGradient id="myhome_svg__c" x1="100%" x2="0%" y1="0%" y2="100%">
        ...
        <circle id="myhome_svg__a" cx={44} cy={44} r={44} />
      </defs>
      <g fill="none" fillRule="evenodd">
        <use fill="#68A4A4" xlinkHref="#myhome_svg__a" />
        <use
          fill="#000"
          filter="url(#myhome_svg__b)"
          xlinkHref="#myhome_svg__a"
        />
        <circle
          cx={45}
          cy={44}
          r={24}
          fill="url(#myhome_svg__c)"
          opacity={0.25}
