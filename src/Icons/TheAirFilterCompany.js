...
function SvgTheAirFilterCompany(props) {
  return (
    <svg width={88} height={88} {...props}>
      <defs>
        <filter
          id="the-air-filter-company_svg__b"
          width="139.8%"
          height="139.8%"
          x="-19.9%"
          y="-19.9%"
        ...
        <circle id="the-air-filter-company_svg__a" cx={44} cy={44} r={44} />
      </defs>
      <g fill="none" fillRule="evenodd">
        <use fill="#1A7373" xlinkHref="#the-air-filter-company_svg__a" />
        <use
          fill="#000"
          filter="url(#the-air-filter-company_svg__b)"
          xlinkHref="#the-air-filter-company_svg__a"
        />
        <path
          fill="#FFF"
